...
## 目录
  ...
  &emsp;&emsp;&emsp;&emsp;[🏷 SQL 的产生与发展](#sql-的产生与发展)
  
  &emsp;&emsp;&emsp;&emsp;[🏷 SQL 的特点](#sql-的特点)
  
  &emsp;&emsp;&emsp;&emsp;[🏷 数据库的创建](#数据库的创建)
  
  &emsp;&emsp;&emsp;&emsp;[🏷 基本表的建立](#基本表的建立)
  
  &emsp;&emsp;&emsp;&emsp;[🏷 数据类型](#数据类型)
  
  &emsp;&emsp;&emsp;&emsp;[🏷 基本表的修改](#基本表的修改)
  
  &emsp;&emsp;&emsp;&emsp;[🏷 基本表的删除](#基本表的删除)
  
  &emsp;&emsp;&emsp;&emsp;[🏷 表中数据的插入](#表中数据的插入)
  
  &emsp;&emsp;&emsp;&emsp;[🏷 表中数据的查询](#表中数据的查询)
  
  &emsp;&emsp;&emsp;&emsp;&emsp;&emsp;[—— csafeadsdf的查询](#表中数据的查询)
  
  &emsp;&emsp;&emsp;&emsp;&emsp;&emsp;[—— asdasdascs](#表中数据的查询)
